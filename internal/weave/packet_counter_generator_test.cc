...
TEST(PacketCounterGeneratorTest, TestNext) {
  PacketCounterGenerator generator;
...
TEST(PacketCounterGeneratorTest, TestNextWrapping) {
  PacketCounterGenerator generator;
  EXPECT_EQ(generator.Next(), 0);
  EXPECT_EQ(generator.Next(), 1);
  EXPECT_EQ(generator.Next(), 2);
...
TEST(PacketCounterGeneratorTest, TestReset) {
  PacketCounterGenerator generator;
  EXPECT_EQ(generator.Next(), 0);
  EXPECT_EQ(generator.Next(), 1);
  EXPECT_EQ(generator.Next(), 2);
